...
export function JsonActions() {
  ...
  const [jsonPrompt, setJsonPrompt] = useState(
    searchParams.get('jsonPrompt') || 'Get me the list of main sections on this webpage.',
  );
    ...
    <div className="space-y-4 mb-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1.5">
          Examples: "Get me all blog post titles", "Extract all images on the page", "List the main navigation links"
        </p>
      </div>
    </div>
  );

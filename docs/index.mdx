...
<Card
  ...
  icon="markdown"
  href="/api-reference/web/extract-markdown-from-a-web-page"
>
...
<Card
  ...
  icon="camera"
  href="/api-reference/web/take-a-screenshot-of-a-web-page"
>
...
<Card
  ...
  icon="file"
  href="/api-reference/web/generate-pdf-from-a-web-page"
>
...
<Card
  title="Web Scraping"
  icon="bug"
  href="/api-reference/web/scrape-specific-elements-from-a-web-page"
>
...
<Card
  ...
  icon="link"
  href="/api-reference/web/extract-links-from-a-web-page"
>
...
<Card
  ...
  icon="square-code"
  href="/api-reference/web/get-raw-html-content-from-a-web-page"
>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="sparkles"
    href="/guides/workflow-automation"
  >
    Chain search → markdown → JSON extraction for instant research briefs
  </Card>
  <Card
    title="E-commerce Store Monitoring"
    icon="shopping-cart"
    href="/guides/ecommerce-use-cases"
  >
  ...
  <Card
    ...
    icon="chart-area"
    href="/guides/workflow-automation#content-intelligence"
  >
    Generate winning content strategies from competitive analysis
  </Card>
  <Card
    title="Price Comparison Reports"
    icon="dollar-sign"
    href="/guides/ecommerce-use-cases#price-report-pdf"
  >

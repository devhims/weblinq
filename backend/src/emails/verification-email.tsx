        ...
        <Container style={container}>
          ...
          <Section style={content}>
            <Text style={welcomeText}>
              Welcome to
              {appName}! We&apos;re excited to have you on board.
            </Text>

            <Text style={paragraph}>
              To complete your account setup and start using {appName}, please verify your email address by clicking the
              button below.
            </Text>
            ...
            <Section style={securityBox}>
              <Text style={securityText}>
                This verification link expires in 1 hour for security. If you didn&apos;t create this account, you can

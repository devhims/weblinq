/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 96d33e1bdd1f3b0d1163922b51f1fb67)
...
declare namespace Cloudflare {
	interface Env {
		...
		PLAYWRIGHT_POOL_DO: DurableObjectNamespace<import("./src/app").PlaywrightPoolDO>;
		R2_BUCKET: R2Bucket;
		D1_DB: D1Database;
		BROWSER: Fetcher;
		AI: Ai;

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: b0f80b0349dc9d1efef9887f72f6c89d)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CDN_DOMAIN" | "CDN_PREVIEW_DOMAIN" | "INITIAL_FREE_CREDITS" | "INITIAL_PRO_CREDITS" | "MONTHLY_PRO_REFILL" | "NODE_ENV" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "FRONTEND_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "API_KEY_PREFIX" | "CLOUDFLARE_ACCESS_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "VERCEL_ACCOUNT_DOMAIN" | "POLAR_ACCESS_TOKEN" | "POLAR_ENVIRONMENT" | "POLAR_PRO_PRODUCT_ID" | "POLAR_SUCCESS_URL" | "POLAR_WEBHOOK_SECRET" | "INTERNAL_API_SECRET" | "ZOHO_EMAIL_HOST" | "ZOHO_EMAIL_USER" | "ZOHO_EMAIL_PASSWORD" | "APP_NAME">> {}
}

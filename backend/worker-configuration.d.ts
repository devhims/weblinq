/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 14f25937a0384cb086b7ed6c0662e38f)
...
declare namespace Cloudflare {
	interface Env {
		...
		TASK_DURABLE_OBJECT: DurableObjectNamespace /* TaskDurableObject */;
		D1_DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "FRONTEND_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "API_KEY_PREFIX">> {}
}

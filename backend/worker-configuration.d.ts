/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 76348141b0d4bcdefd8cf8ffebfbd57f)
...
declare namespace Cloudflare {
  interface Env {
    ...
    TASK_DURABLE_OBJECT: DurableObjectNamespace<
      import('./src/app').TaskDurableObject
    >;
    WEBLINQ_DURABLE_OBJECT: DurableObjectNamespace<
      import('./src/app').WebDurableObject
    >;
    BROWSER_MANAGER_DO: DurableObjectNamespace<
      import('./src/app').BrowserManagerDO
    > /* BrowserManagerDO */;
    BROWSER_DO: DurableObjectNamespace<
      import('./src/app').BrowserDO
    > /* BrowserDO */;
    D1_DB: D1Database;
    BROWSER: Fetcher;
  }

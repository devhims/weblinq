/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 17b1dce40faa449a7290a5743ac81783)
// Runtime types generated with workerd@1.20250712.0 2025-07-18 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ENVIRONMENT: "development";
		PLAYWRIGHT_BROWSER_DO: DurableObjectNamespace<import("./src/index").PlaywrightBrowserDO>;
		PLAYWRIGHT_MANAGER_DO: DurableObjectNamespace<import("./src/index").PlaywrightManagerDO>;
		PLAYWRIGHT_POOL_DO: DurableObjectNamespace<import("./src/index").PlaywrightPoolDO>;
		PLAYWRIGHT_BROWSER: Fetcher;
	}
}
